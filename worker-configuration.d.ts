/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 85da9f06cf1beca07d0abd2c6abdc3bb)
// Runtime types generated with workerd@1.20260917.1 2026-09-15 nodejs_compat
interface __BaseEnv_Env {
	...
	DB_D1_ENDPOINT: string;
	CACHE_DRIVER: string;
	FILESYSTEM_DRIVER: string;
	LOG_CHANNEL: string;
	R2_ENDPOINT: string;
	MAIL_ENDPOINT: string;
	CONTAINER: DurableObjectNamespace<import("./worker").AtrelladoContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "AtrelladoContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "APP_LOG_LEVEL" | "DB_CONNECTION" | "BROADCAST_DRIVER" | "SESSION_DRIVER" | "SESSION_LIFETIME" | "QUEUE_DRIVER" | "MAIL_MAILER" | "MAIL_HOST" | "MAIL_PORT" | "MAIL_ENCRYPTION" | "MAIL_FROM_ADDRESS" | "MAIL_FROM_NAME" | "DB_D1_ENDPOINT" | "CACHE_DRIVER" | "FILESYSTEM_DRIVER" | "LOG_CHANNEL" | "R2_ENDPOINT" | "MAIL_ENDPOINT">> {}
}
